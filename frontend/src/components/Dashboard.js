      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            ...
            <p className="stat-value">${stats.portfolioValue.toFixed(2)}</p>
        ...
        <div className="network-status-panel">
          ...
          <div className="network-details">
            ...
            <div className="detail">
              ...
              <span className="value">{networkInfo.serverInfo?.validated_ledger?.seq?.toLocaleString()}</span>
            </div>
            <div className="detail">
              <span className="label">Base Reserve:</span>
              <span className="value">{networkInfo.serverInfo?.validated_ledger?.reserve_base_xrp} XRP</span>
            </div>
          </div>
        </div>
      )}
